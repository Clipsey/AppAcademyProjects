...
def pow(base, exponent)
    ...
    #pow(base, tracked_number, exponent)

    #pow(base, base * tracked_number, exponent-1)
    # (2, 4) -> 2 * (2, 3)
    # (2, 3) -> 2 * 2 * (2, 2)
    # (2, 2) -> 2 * 2 * 2 * (2, 1)
    # (2, 1) == 2 * 2 * 2 * 2 == 16

    # 2 * pow(2, 4 - 1) == 2 * 2 * pow(2, 3 - 1) == 2 * 2 * 2 *
...
def reverse_string(str)
    ...
    #last_char + reverse_string(str - last char)
    #last_char + last_char(2) + reverse_string(str - last_char - last_char(2))
end
